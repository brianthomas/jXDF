...
// XDFEntity.java Copyright (C) 2001 Brian Thomas,
...
import java.io.OutputStreamWriter;
 ...
 /**
  *  The XDFEntity class is nothing more than a simple object that holds information
  *  concerning the href and its associated (XML) ENTITY reference. 
  *  @version $Revision$
  */

 public class XDFEntity extends BaseObject {
...
//   private static final String BASE_XML_ATTRIBUTE_NAME = new String("base");
  ...
  /**  This constructor takes a Java Hashtable as an initializer of
    ...
    */
  public XDFEntity ( Hashtable InitXDFAttributeTable )
  {
