...
// XDF ExponentOn Class
// CVS $Id$

// ExponentOn.java Copyright (C) 2003 Brian Thomas,
...
/**
   An XDF::ExponentOn is a class that defines a conversion component that converts a set value using the passed value as the exponent on that set value. 
   @version $Revision$
 */


public class ExponentOn extends BaseObject implements ConversionComponentInterface {
   ...
   public ExponentOn (Double number) {
      init();
      setValue(number);
   }

   public ExponentOn (double doubleValue) {
      this(new Double(doubleValue));
   }

   /** The no argument constructor.
    */
   public ExponentOn ()  //DataFormat no-arg constructor should be been called
   {
      init();
   }
    ...
    */
   public double evaluate (double exponentValue) {
