...
// XDF XMLNotation Class
// CVS $Id$

// XMLNotation.java Copyright (C) 2001 Brian Thomas,
...
import java.io.OutputStreamWriter;
 ...
 /**
  *  The XMLNotation class is nothing more than a simple object that holds information
  *  concerning the href and its associated (XML) ENTITY reference. 
  *  @version $Revision$
  */

 public class XMLNotation extends BaseObject {
...
//   private static final String BASE_XML_ATTRIBUTE_NAME = new String("base");
  ...
  /**  This constructor takes a Java Hashtable as an initializer of
    ...
    */
  public XMLNotation ( Hashtable InitXDFAttributeTable )
  {
   ...
   */
//  public void setBase(String value) { ((XMLAttribute) attribHash.get(BASE_XML_ATTRIBUTE_NAME)).setAttribValue(value); }

  /*
   * @return the current *base* attribute
   */
//  public String getBase() { return (String) ((XMLAttribute) attribHash.get(BASE_XML_ATTRIBUTE_NAME)).getAttribValue(); }
