...
// Multiply.java Copyright (C) 2003 Brian Thomas,
...
/**
   An XDF::Multiply is a class that defines an multiplication component for an 
   XDF::ConversionComponent object.
   @version $Revision$
 */


public class Multiply extends BaseObject implements ConversionComponentInterface {
   ...
   public Multiply (double doubleValue) {
      this(new Double(doubleValue));
   }

   /** The no argument constructor.
    */
   public Multiply ()  //DataFormat no-arg constructor should be been called
   {
      init();
   }
   ...
   public double evaluate (double value) {
       double multiValue = getValue().doubleValue();
