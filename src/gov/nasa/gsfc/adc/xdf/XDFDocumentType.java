...
// XDF XDFDocumentType Class
// CVS $Id$

// XDFDocumentType.java Copyright (C) 2001 Brian Thomas,
...
import java.io.StringWriter;
 ...
 /**
  *  The XDFDocumentType class is nothing more than a simple object that holds information
  *  concerning the DOCTYPE statement and its associated child entities (href, notation)
  *  for a given XDF object.
  *  @version $Revision$
  */

 public class XDFDocumentType extends BaseObject {
   ...
   public XDFDocumentType (XDF xdf)
   {
      owner = xdf;
   }
   ...
   public void addNotation (XMLNotation obj) {
      notationList.add(obj);
   }
 
   public void removeNotation (XMLNotation obj) {
   ...
   public boolean removeNotation (String name) {
      ...
      while (iter.hasNext()) { 
         XMLNotation obj = (XMLNotation) iter.next();
   ...
   throws java.io.IOException
   {
      ...
      if (entityObjList.size() > 0) {
         ...
         synchronized (entityObjList) {
            ...
            while (iter.hasNext()) {
               XDFEntity entityObj = (XDFEntity) iter.next();
