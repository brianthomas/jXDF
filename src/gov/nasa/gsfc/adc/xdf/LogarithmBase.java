...
// XDF LogarithmBase Class
// CVS $Id$

// LogarithmBase.java Copyright (C) 2003 Brian Thomas,
...
/**
   An XDF::LogarithmBase is a class that defines an multiplication component for an 
   XDF::ConversionComponent object.
   @version $Revision$
 */


public class LogarithmBase extends BaseObject implements ConversionComponentInterface {
   ...
   public LogarithmBase (Double number) {
      init();
      setValue(number);
   }

   public LogarithmBase (double doubleValue) {
      this(new Double(doubleValue));
   }

   /** The no argument constructor.
    */
   public LogarithmBase ()  //DataFormat no-arg constructor should be been called
   {
      init();
   }
   ...
   protected void init() {
     ...
     classXDFNodeName = "logarithmBase";
